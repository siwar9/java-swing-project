...
public class etudiants {
	...
	private void initialize() {
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						while(rs.next())
						{row[0]=rs.getInt("ID_Etud");
						row[1]=rs.getString("Nom_Etud");
						row[2]=rs.getString("Prenom_Etud");
						row[3]=rs.getString("Email_Etud");
						model.addRow(row);
						}
						}
						catch(Exception exp)
		...
		Object[]column= {"ID_Etud","Nom_Etud","Prenom_Etud","Email_Etud"};
